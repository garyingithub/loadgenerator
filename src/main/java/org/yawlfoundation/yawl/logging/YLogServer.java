...
import org.yawlfoundation.yawl.logging.SpecHistory;
...
public class YLogServer {
    ...
    private static org.yawlfoundation.yawl.logging.YLogServer _instance;
    private HibernateEngine _logDb;
    private static final Logger _log = LogManager.getLogger(org.yawlfoundation.yawl.logging.YLogServer.class);
    ...
    private YLogServer() {
        if (YEngine.isPersisting()) {
            _logDb = org.yawlfoundation.yawl.logging.YEventLogger.getInstance().getDb();
        }
    }

    public static org.yawlfoundation.yawl.logging.YLogServer getInstance() {
        if (_instance == null) _instance = new org.yawlfoundation.yawl.logging.YLogServer();
        return _instance;
    }
