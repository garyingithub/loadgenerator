...
import org.yawlfoundation.yawl.logging.YEventKeyCache;
...
public class YEventLogger {
    ...
    private final Logger _log = LogManager.getLogger(org.yawlfoundation.yawl.logging.YEventLogger.class);
    private boolean _enabled = true;
    private static org.yawlfoundation.yawl.logging.YEventLogger INSTANCE = null;
     ...
     */
    public static org.yawlfoundation.yawl.logging.YEventLogger getInstance(YEngine engine) {
        if (INSTANCE == null) INSTANCE = new org.yawlfoundation.yawl.logging.YEventLogger();
    ...
    /** @return an instantiated event logger */
    public static org.yawlfoundation.yawl.logging.YEventLogger getInstance() {
        if (INSTANCE == null) INSTANCE = new org.yawlfoundation.yawl.logging.YEventLogger();
        return INSTANCE;
    }
