 ...
 */
public class YLogDataItemList extends ArrayList<org.yawlfoundation.yawl.logging.YLogDataItem> {

    public YLogDataItemList() {
        super();
    }

    public YLogDataItemList(org.yawlfoundation.yawl.logging.YLogDataItem firstItem) {
        super();
        this.add(firstItem);
    }
    ...
    public String toXML() {
        ...
        for (org.yawlfoundation.yawl.logging.YLogDataItem item : this) {
            s.append(item.toXML());
        }
