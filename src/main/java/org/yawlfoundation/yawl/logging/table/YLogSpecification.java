...
public class YLogSpecification {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.logging.table.YLogSpecification) &&
                (this.getRowKey() == ((org.yawlfoundation.yawl.logging.table.YLogSpecification) other).getRowKey());
    }
