...
public class YLogEvent {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.logging.table.YLogEvent) &&
                (this.getEventID() == ((org.yawlfoundation.yawl.logging.table.YLogEvent) other).getEventID());
    }
