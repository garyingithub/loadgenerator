...
public class YLogDataType {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.logging.table.YLogDataType) &&
                (this.getDataTypeID() == ((org.yawlfoundation.yawl.logging.table.YLogDataType) other).getDataTypeID());
    }
