...
public class YLogNetInstance {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.logging.table.YLogNetInstance) &&
                (this.getNetInstanceID() == ((org.yawlfoundation.yawl.logging.table.YLogNetInstance) other).getNetInstanceID());
    }
