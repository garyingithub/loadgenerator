...
public class YLogDataItemInstance {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.logging.table.YLogDataItemInstance) &&
                (this.getDataItemID() == ((org.yawlfoundation.yawl.logging.table.YLogDataItemInstance) other).getDataItemID());
    }
