...
public class YLogTaskInstance {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.logging.table.YLogTaskInstance) &&
                (this.getTaskInstanceID() == ((org.yawlfoundation.yawl.logging.table.YLogTaskInstance) other).getTaskInstanceID());
    }
