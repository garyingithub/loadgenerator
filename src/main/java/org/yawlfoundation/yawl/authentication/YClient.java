...
public class YClient {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.authentication.YClient) &&
                ((getUserName() != null) ?
                  getUserName().equals(((org.yawlfoundation.yawl.authentication.YClient) other).getUserName()) :
                        super.equals(other));
    }
