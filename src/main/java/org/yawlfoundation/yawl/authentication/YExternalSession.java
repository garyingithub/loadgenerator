...
public class YExternalSession extends YSession {
    ...
    private org.yawlfoundation.yawl.authentication.YExternalClient _client;                          // the connected client

    public YExternalSession(org.yawlfoundation.yawl.authentication.YExternalClient client, long timeOutSeconds) {
    ...
    public void setClient(org.yawlfoundation.yawl.authentication.YExternalClient client) {
        _client = client;
    }
