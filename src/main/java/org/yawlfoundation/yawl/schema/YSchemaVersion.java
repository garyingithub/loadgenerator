...
public enum YSchemaVersion {
    ...
    public static org.yawlfoundation.yawl.schema.YSchemaVersion DEFAULT_VERSION = ThreePointZero;
    ...
    private static final Map<String, org.yawlfoundation.yawl.schema.YSchemaVersion> _fromStringMap =
            new HashMap<String, org.yawlfoundation.yawl.schema.YSchemaVersion>();


    static {
        for (org.yawlfoundation.yawl.schema.YSchemaVersion version : values()) {
    ...
    public static org.yawlfoundation.yawl.schema.YSchemaVersion fromString(String s) {
    ...
    public boolean isVersionAtLeast(org.yawlfoundation.yawl.schema.YSchemaVersion referenceVersion) {
    ...
    public static org.yawlfoundation.yawl.schema.YSchemaVersion defaultVersion() { return DEFAULT_VERSION; }
    ...
    public String getSchemaLocation(String s) {
        org.yawlfoundation.yawl.schema.YSchemaVersion version = fromString(s);
    ...
    private String getAbsoluteSchemaFileName() {
        return "/schema/" + getSchemaFileName();
    }
