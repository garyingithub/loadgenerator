...
import org.yawlfoundation.yawl.schema.Input;
...
public class ResourceResolver implements LSResourceResolver {
    ...
    private static final org.yawlfoundation.yawl.schema.ResourceResolver INSTANCE = new org.yawlfoundation.yawl.schema.ResourceResolver();

    private ResourceResolver() { cache = new HashMap<URL, String>(); }


    public static org.yawlfoundation.yawl.schema.ResourceResolver getInstance() { return INSTANCE; }
