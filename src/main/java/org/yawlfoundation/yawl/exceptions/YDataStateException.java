...
public class YDataStateException extends YAWLException {
    ...
    public static org.yawlfoundation.yawl.exceptions.YDataStateException unmarshall(Document exceptionDoc) {
        ...
        return new org.yawlfoundation.yawl.exceptions.YDataStateException(
