...
public class YAWLException extends Exception {
    ...
    public static org.yawlfoundation.yawl.exceptions.YAWLException unmarshal(Document exceptionDoc) throws JDOMException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        org.yawlfoundation.yawl.exceptions.YAWLException e = (org.yawlfoundation.yawl.exceptions.YAWLException) Class.forName(exceptionType).newInstance();
