...
public class XNode implements Comparable<org.yawlfoundation.yawl.util.XNode> {
    ...
    private org.yawlfoundation.yawl.util.XNode _parent;
    private List<org.yawlfoundation.yawl.util.XNode> _children;
    ...
    public int compareTo(org.yawlfoundation.yawl.util.XNode other) {
    ...
    public org.yawlfoundation.yawl.util.XNode insertChild(int index, org.yawlfoundation.yawl.util.XNode child) {
        if (child != null) {
            acceptChild(child);
    ...
    public org.yawlfoundation.yawl.util.XNode addChild(org.yawlfoundation.yawl.util.XNode child) {
        if (child != null) {
            acceptChild(child);
            _children.add(child);
        }
    ...
    public org.yawlfoundation.yawl.util.XNode addChild(String name) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, String text) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, text));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, boolean b) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(b)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, long l) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(l)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, int i) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(i)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, byte b) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(b)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, short s) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(s)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, double d) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(d)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, float f) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, String.valueOf(f)));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, Object o) {
        return addChild(new org.yawlfoundation.yawl.util.XNode(name, o.toString()));
    }

    public org.yawlfoundation.yawl.util.XNode addChild(String name, String text, boolean escape) {
        if (escape) {
    ...
    public void addChildren(Collection<org.yawlfoundation.yawl.util.XNode> children) {
        for (org.yawlfoundation.yawl.util.XNode child : children) addChild(child);
    }
    ...
    public boolean removeChild(org.yawlfoundation.yawl.util.XNode child) {
    ...
    public void addContent(String content, String nsPrefix, String nsURI) {
        ...
        org.yawlfoundation.yawl.util.XNode tempNode = new XNodeParser(true).parse(wrappedContent);
        if (tempNode != null) {
            for (org.yawlfoundation.yawl.util.XNode child : tempNode.getChildren()) {
                addChild(child);
            }
        }
    }
    ...
    public <E extends XNodeIO> void populateCollection(Collection<E> list, E instance) {
        for (org.yawlfoundation.yawl.util.XNode child : getChildren(ContentType.text)) {
    ...
    public org.yawlfoundation.yawl.util.XNode addComment(String comment) {
        org.yawlfoundation.yawl.util.XNode child = addChild("_!_", comment);
        child.setContentType(ContentType.comment);
        return child;
    }

    public org.yawlfoundation.yawl.util.XNode insertComment(int index, String comment) {
        org.yawlfoundation.yawl.util.XNode child = new org.yawlfoundation.yawl.util.XNode("_!_", comment);
        child.setContentType(ContentType.comment);
    ...
    public org.yawlfoundation.yawl.util.XNode addCDATA(String cdata) {
        org.yawlfoundation.yawl.util.XNode child = addChild("_[_", cdata);
    ...
    public org.yawlfoundation.yawl.util.XNode getChild(String name) {
        if (_children != null) {
            for (org.yawlfoundation.yawl.util.XNode child : _children) {
    ...
    public org.yawlfoundation.yawl.util.XNode getOrAddChild(String name) {
        org.yawlfoundation.yawl.util.XNode child = getChild(name);
        if (child == null) {
            child = addChild(name);
        }
        return child;
    ...
    public org.yawlfoundation.yawl.util.XNode getChild() {
        if (_children != null) {
            for (org.yawlfoundation.yawl.util.XNode child : _children) {
    ...
    public org.yawlfoundation.yawl.util.XNode getChild(int index) {
        return (index < 0 || index >= _children.size()) ? null : _children.get(index);
    }


    public List<org.yawlfoundation.yawl.util.XNode> getChildren() {
        return (_children != null) ? _children : Collections.<org.yawlfoundation.yawl.util.XNode>emptyList();
    }


    public List<org.yawlfoundation.yawl.util.XNode> getChildren(ContentType cType) {
        List<org.yawlfoundation.yawl.util.XNode> matches = new ArrayList<org.yawlfoundation.yawl.util.XNode>();
        for (org.yawlfoundation.yawl.util.XNode child : getChildren()) {
    ...
    public List<org.yawlfoundation.yawl.util.XNode> getChildren(String name) {
        List<org.yawlfoundation.yawl.util.XNode> namedChildren = new ArrayList<org.yawlfoundation.yawl.util.XNode>();
        if (_children != null) {
            for (org.yawlfoundation.yawl.util.XNode child : _children) {
    ...
    public void setParent(org.yawlfoundation.yawl.util.XNode parent) {
        _parent = parent;
    }

    public org.yawlfoundation.yawl.util.XNode getParent() {
        return _parent;
    }
    ...
    public void sort(Comparator<org.yawlfoundation.yawl.util.XNode> comparator) {
    ...
    private org.yawlfoundation.yawl.util.XNode acceptChild(org.yawlfoundation.yawl.util.XNode child) {
        if (child != null) {
            if (_children == null) _children = new ArrayList<org.yawlfoundation.yawl.util.XNode>();
