...
import org.yawlfoundation.yawl.elements.predicate.*;
...
public class PredicateEvaluatorFactory {
    ...
    private static Map<String, Class<org.yawlfoundation.yawl.elements.predicate.PredicateEvaluator>> _classMap;
    ...
    public static Set<org.yawlfoundation.yawl.elements.predicate.PredicateEvaluator> getInstances() {
        return _loader.toInstanceSet(getClassMap().values());
    }


    private static Map<String, Class<org.yawlfoundation.yawl.elements.predicate.PredicateEvaluator>> getClassMap() {
        if (_classMap == null) {
