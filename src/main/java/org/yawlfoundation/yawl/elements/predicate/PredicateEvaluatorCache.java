...
public class PredicateEvaluatorCache {
    ...
    private static Set<org.yawlfoundation.yawl.elements.predicate.PredicateEvaluator> _evaluators;



    public static String process(YDecomposition decomposition, String predicate,
                                 YIdentifier token) {
        org.yawlfoundation.yawl.elements.predicate.PredicateEvaluator evaluator = getEvaluator(predicate);
    ...
    private static org.yawlfoundation.yawl.elements.predicate.PredicateEvaluator getEvaluator(String predicate) {
        try {
            if (_evaluators == null) {
