...
public class YSpecVersion implements Comparable<org.yawlfoundation.yawl.elements.YSpecVersion> {
    private int _major;
    private int _minor;
    ...
    public int compareTo(org.yawlfoundation.yawl.elements.YSpecVersion other) {
    ...
    public boolean equalsMajorVersion(org.yawlfoundation.yawl.elements.YSpecVersion other) {
        return this.getMajorVersion() == other.getMajorVersion();
    }

    public boolean equalsMinorVersion(org.yawlfoundation.yawl.elements.YSpecVersion other) {
        return this.getMinorVersion() == other.getMinorVersion();
    }

    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.elements.YSpecVersion) &&
                this.equalsMajorVersion((org.yawlfoundation.yawl.elements.YSpecVersion) other) &&
                this.equalsMinorVersion((org.yawlfoundation.yawl.elements.YSpecVersion) other);
    }
