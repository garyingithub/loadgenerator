...
public class YAWLServiceReference extends YClient implements YVerifiable {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.elements.YAWLServiceReference) &&
                ((getServiceID() != null) ?
                getServiceID().equals(((org.yawlfoundation.yawl.elements.YAWLServiceReference) other).getServiceID()) :
                super.equals(other));
    }
    ...
    public void verify(YVerificationHandler handler) {
        try {
            if (YEngine.isRunning()) {
                ...
                org.yawlfoundation.yawl.elements.YAWLServiceReference service = engine.getRegisteredYawlService(_yawlServiceID);
                if (service == null) {
                    handler.warn(this,
     ...
     */
    public static org.yawlfoundation.yawl.elements.YAWLServiceReference unmarshal(String serialisedService) {
        org.yawlfoundation.yawl.elements.YAWLServiceReference service = null;
        ...
        if (serviceElem != null) {
            ...
            service =  new org.yawlfoundation.yawl.elements.YAWLServiceReference(uri, null, name, password);
