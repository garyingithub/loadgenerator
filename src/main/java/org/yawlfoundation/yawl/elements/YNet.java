...
public final class YNet extends YDecomposition {
    ...
    private org.yawlfoundation.yawl.elements.YNet _clone;
    ...
    public Object clone() {
        try {
            _clone = (org.yawlfoundation.yawl.elements.YNet) super.clone();
    ...
    protected org.yawlfoundation.yawl.elements.YNet getCloneContainer() {
        return _clone;
    }
