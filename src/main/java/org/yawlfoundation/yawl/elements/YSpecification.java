...
public final class YSpecification implements Cloneable, YVerifiable {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.elements.YSpecification) ?  // instanceof = false if other is null
                getSpecificationID().equals(((org.yawlfoundation.yawl.elements.YSpecification) other).getSpecificationID())
                : super.equals(other);
    }
