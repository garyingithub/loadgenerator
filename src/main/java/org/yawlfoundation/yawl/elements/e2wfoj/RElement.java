 ...
 **/
  ...
  public Set getPresetElements() {
   ...
   public void setPreset(RFlow flowsInto) {
    ...
    public org.yawlfoundation.yawl.elements.e2wfoj.RElement getPostsetElement(String id) {
/*        if (_postset.size() > 0) {
     ...
     */
    public org.yawlfoundation.yawl.elements.e2wfoj.RElement getPresetElement(String id){
