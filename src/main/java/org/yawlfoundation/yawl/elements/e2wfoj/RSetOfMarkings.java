...
public class RSetOfMarkings {
    ...
    public void addAll(org.yawlfoundation.yawl.elements.e2wfoj.RSetOfMarkings newmarkings) {
        _markings.addAll(newmarkings.getMarkings());

    }

    public boolean equals(org.yawlfoundation.yawl.elements.e2wfoj.RSetOfMarkings markings) {
