...
public class RMarking {
    ...
    public RMarking(List locations) {
        ...
        for (Iterator iterator = locations.iterator(); iterator.hasNext();) {
            org.yawlfoundation.yawl.elements.e2wfoj.RElement netElement = (RElement) iterator.next();
    ...
    public boolean equals(Object omarking) {
        if (!(omarking instanceof org.yawlfoundation.yawl.elements.e2wfoj.RMarking)) {
            return false;
        }
        org.yawlfoundation.yawl.elements.e2wfoj.RMarking marking = (org.yawlfoundation.yawl.elements.e2wfoj.RMarking) omarking;
    ...
    public boolean isBiggerThanOrEqual(org.yawlfoundation.yawl.elements.e2wfoj.RMarking marking) {
    ...
    public boolean isBiggerThan(org.yawlfoundation.yawl.elements.e2wfoj.RMarking marking) {
     ...
     *
     **/
    public boolean isLessThanOrEqual(org.yawlfoundation.yawl.elements.e2wfoj.RMarking marking) {
        Map otherMarking = marking.getMarkedPlaces();
        Set myPlaces = _markedPlaces.keySet();
        Set otherPlaces = otherMarking.keySet();
