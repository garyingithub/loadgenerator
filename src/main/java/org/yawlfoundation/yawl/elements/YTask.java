...
public abstract class YTask extends YExternalNetElement {
    ...
    private static final Logger logger = LogManager.getLogger(org.yawlfoundation.yawl.elements.YTask.class);
    ...
    private synchronized void t_exit(YPersistenceManager pmgr)
        ...
        for (YExternalNetElement netElement : _removeSet) {
            if (netElement instanceof org.yawlfoundation.yawl.elements.YTask) {
                ((org.yawlfoundation.yawl.elements.YTask) netElement).cancel(pmgr);
    ...
    public Object clone() throws CloneNotSupportedException {
        org.yawlfoundation.yawl.elements.YTask copy = (org.yawlfoundation.yawl.elements.YTask) super.clone();
