 ...
 *         Time: 16:10:14
 */
public class YVariable implements Cloneable, YVerifiable, Comparable<org.yawlfoundation.yawl.elements.data.YVariable> {
    ...
    public int compareTo(org.yawlfoundation.yawl.elements.data.YVariable other) {
