...
import org.yawlfoundation.yawl.elements.data.external.*;
...
public class ExternalDBGatewayFactory {
    ...
    private static Map<String, Class<org.yawlfoundation.yawl.elements.data.external.AbstractExternalDBGateway>> _classMap;
     ...
     */
    public static org.yawlfoundation.yawl.elements.data.external.AbstractExternalDBGateway getInstance(String classname) {
        if (isExternalDBMappingExpression(classname)) {
            classname = getMappingClassFromExpression(classname);
        }
        classname = qualify(classname, "");
        Class<org.yawlfoundation.yawl.elements.data.external.AbstractExternalDBGateway> gatewayClass = getClassMap().get(classname);
        return (gatewayClass != null) ? _loader.newInstance(gatewayClass) :
                _loader.loadInstance(org.yawlfoundation.yawl.elements.data.external.AbstractExternalDBGateway.class, classname);
    }
     ...
     */
    public static Set<org.yawlfoundation.yawl.elements.data.external.AbstractExternalDBGateway> getInstances() {
        return _loader.toInstanceSet(getClassMap().values());
    }


    private static Map<String, Class<org.yawlfoundation.yawl.elements.data.external.AbstractExternalDBGateway>> getClassMap() {
        if (_classMap == null) {
