...
public class HibernateEngine {
    ...
    // instance reference
    private static org.yawlfoundation.yawl.elements.data.external.HibernateEngine _me;

    private static final Logger _log = LogManager.getLogger(org.yawlfoundation.yawl.elements.data.external.HibernateEngine.class);
    ...
    public static org.yawlfoundation.yawl.elements.data.external.HibernateEngine getInstance() {
        if (_me == null) {
            try {
                _me = new org.yawlfoundation.yawl.elements.data.external.HibernateEngine();
            }
