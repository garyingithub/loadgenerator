...
import org.yawlfoundation.yawl.engine.interfce.interfaceB.IBControllerCache;
...
public abstract class InterfaceBWebsideController {
    protected org.yawlfoundation.yawl.engine.interfce.interfaceB.InterfaceB_EnvironmentBasedClient _interfaceBClient;
    ...
    public String connect(String userID, String password) throws IOException {
        String result= _interfaceBClient.connect(userID, password);
    ...
    public static void logContactError(IOException e, String backEndURIStr) {
        LogManager.getLogger(org.yawlfoundation.yawl.engine.interfce.interfaceB.InterfaceBWebsideController.class).error(
                "[error] problem contacting YAWL engine at URI [" + backEndURIStr + "]");
        if (e.getStackTrace() != null) {
            LogManager.getLogger(org.yawlfoundation.yawl.engine.interfce.interfaceB.InterfaceBWebsideController.class).error("line of code := " +
