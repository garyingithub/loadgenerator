...
import org.yawlfoundation.yawl.engine.interfce.interfaceX.ExceptionGateway;
...
public class InterfaceX_EngineSideClient extends Interface_Client implements ExceptionGateway {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.engine.interfce.interfaceX.InterfaceX_EngineSideClient) &&
               (getURI() != null) &&
                getURI().equals(((org.yawlfoundation.yawl.engine.interfce.interfaceX.InterfaceX_EngineSideClient) other).getURI());
    }
    ...
    private class Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                LogManager.getLogger(org.yawlfoundation.yawl.engine.interfce.interfaceX.InterfaceX_EngineSideClient.class).error(
