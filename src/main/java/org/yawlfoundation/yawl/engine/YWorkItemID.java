...
public class YWorkItemID {
    private static final char[] _uniqifier = org.yawlfoundation.yawl.engine.UniqueIDGenerator.newAlphas();
    ...
    public YWorkItemID(YIdentifier caseID, String taskID, String uniqueID) {
        ...
        if (uniqueID != null) {
            ...
            while (compare(_uniqifier, uniqueID.toCharArray()) > 0) {
                org.yawlfoundation.yawl.engine.UniqueIDGenerator.nextInOrder(_uniqifier);
            }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof org.yawlfoundation.yawl.engine.YWorkItemID) {
            org.yawlfoundation.yawl.engine.YWorkItemID otherID = (org.yawlfoundation.yawl.engine.YWorkItemID) other;
