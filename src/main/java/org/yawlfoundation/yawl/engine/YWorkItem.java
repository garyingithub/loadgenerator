...
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusComplete;
import static org.yawlfoundation.yawl.engine.YWorkItemStatus.statusForcedComplete;
...
public class YWorkItem {
    ...
    private static org.yawlfoundation.yawl.engine.YEngine _engine = YEngine.getInstance();
    ...
    private org.yawlfoundation.yawl.engine.YWorkItem _parent;                            // this item's parent (if any)
    private Set<org.yawlfoundation.yawl.engine.YWorkItem> _children;                     // this item's kids (if any)
    ...
    private final Logger _log = LogManager.getLogger(org.yawlfoundation.yawl.engine.YWorkItem.class);
    ...
    private YWorkItem(YPersistenceManager pmgr, YWorkItemID workItemID,
                      YSpecificationID specID, Date workItemCreationTime, org.yawlfoundation.yawl.engine.YWorkItem parent,
    ...
    private void completeParentPersistence(YPersistenceManager pmgr)
        ...
        synchronized(_parent) {                      // sequentially handle children
            ...
            if (_parent.getChildren().size() >  1) {  // short-circuit if not multi-task
                for (org.yawlfoundation.yawl.engine.YWorkItem mysibling : _parent.getChildren()) {
    ...
    private void logAndUnpersist(YPersistenceManager pmgr, org.yawlfoundation.yawl.engine.YWorkItem item)
            throws YPersistenceException {
        _eventLog.logWorkItemEvent(item, _status, createLogDataList(_status.name()));
    ...
    public org.yawlfoundation.yawl.engine.YWorkItem createChild(YPersistenceManager pmgr, YIdentifier childCaseID)
           throws YPersistenceException {
        if (this._parent == null) {
            ...
            if (_children == null) {
                _children = new HashSet<org.yawlfoundation.yawl.engine.YWorkItem>();
                _eventLog.logWorkItemEvent(this, _status, createLogDataList("createChild"));
            }

            org.yawlfoundation.yawl.engine.YWorkItem childItem = new org.yawlfoundation.yawl.engine.YWorkItem(pmgr,
    ...
    public void cancel(YPersistenceManager pmgr) throws YPersistenceException {
        if (pmgr != null) {
            ...
            Set<org.yawlfoundation.yawl.engine.YWorkItem> children = getChildren();
            if (children != null) {
                for (org.yawlfoundation.yawl.engine.YWorkItem child : children) {
    ...
    private void deleteWorkItem(YPersistenceManager pmgr, org.yawlfoundation.yawl.engine.YWorkItem item)
            throws YPersistenceException {
    ...
    public void cancelTimer() {
        ...
        org.yawlfoundation.yawl.engine.YWorkItem parent = getParent();
        if (parent != null && parent.hasTimerStarted()) {
            Set<org.yawlfoundation.yawl.engine.YWorkItem> children = parent.getChildren();
            if (children != null) {
                for (org.yawlfoundation.yawl.engine.YWorkItem child : children) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof org.yawlfoundation.yawl.engine.YWorkItem) {         // instanceof = false if other is null
            org.yawlfoundation.yawl.engine.YWorkItem otherItem = (org.yawlfoundation.yawl.engine.YWorkItem) other;
    ...
    public void setStatusToUnsuspended(YPersistenceManager pmgr)
        ...
        _prevStatus = null ;
        _eventLog.logWorkItemEvent(this, "resume", createLogDataList("resume"));
    }
    ...
    public void set_parent(org.yawlfoundation.yawl.engine.YWorkItem parent) { _parent = parent; }

    public org.yawlfoundation.yawl.engine.YWorkItem get_parent() { return _parent; }

    public Set get_children() { return _children; }

    public boolean hasChildren() { return _children != null; }

    public void add_child(org.yawlfoundation.yawl.engine.YWorkItem child) { _children.add(child); }
    ...
    public org.yawlfoundation.yawl.engine.YWorkItem getParent() { return _parent; }

    public Set<org.yawlfoundation.yawl.engine.YWorkItem> getChildren() { return _children; }
