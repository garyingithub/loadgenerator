...
public class YAnnouncement {
    ...
    private final org.yawlfoundation.yawl.engine.announcement.AnnouncementContext _context;
    private final YEngineEvent _event;


    public YAnnouncement(YAWLServiceReference service, YWorkItem item, YEngineEvent event,
                         org.yawlfoundation.yawl.engine.announcement.AnnouncementContext context) {
    ...
    public YAnnouncement(YAWLServiceReference service, YWorkItem item, YEngineEvent event) {
        this(service, item, event, org.yawlfoundation.yawl.engine.announcement.AnnouncementContext.NORMAL);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof org.yawlfoundation.yawl.engine.announcement.YAnnouncement) {
            org.yawlfoundation.yawl.engine.announcement.YAnnouncement other = (org.yawlfoundation.yawl.engine.announcement.YAnnouncement) o;
