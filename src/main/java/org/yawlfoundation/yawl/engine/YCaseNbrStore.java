...
public class YCaseNbrStore {
    ...
    private static org.yawlfoundation.yawl.engine.YCaseNbrStore _instance ;
    private static final Logger log = LogManager.getLogger(org.yawlfoundation.yawl.engine.YCaseNbrStore.class) ;
    ...
    public static org.yawlfoundation.yawl.engine.YCaseNbrStore getInstance() {
        if (_instance == null)
            _instance = new org.yawlfoundation.yawl.engine.YCaseNbrStore();
        return _instance ;
    }
