...
public class YNetRunner {
    ...
    private static final Logger _logger = LogManager.getLogger(org.yawlfoundation.yawl.engine.YNetRunner.class);
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.engine.YNetRunner) &&   // instanceof = false if other is null
                ((getCaseID() != null) ? getCaseID().equals(((org.yawlfoundation.yawl.engine.YNetRunner) other).getCaseID())
                : super.equals(other));
    }
        ...
        if (busyCompositeTask.t_complete(pmgr, caseIDForSubnet, rawSubnetData)) {
            ...
            if (endOfNetReached()) {
                if (_containingCompositeTask != null) {
                    org.yawlfoundation.yawl.engine.YNetRunner parentRunner = _engine.getNetRunner(_caseIDForNet.getParent());
