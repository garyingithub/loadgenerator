...
public class YWorkItemTimer implements YTimedObject {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.engine.time.YWorkItemTimer) &&
                ((getOwnerID() != null) ?
                 getOwnerID().equals(((org.yawlfoundation.yawl.engine.time.YWorkItemTimer) other).getOwnerID()) :
                 super.equals(other));
    }
