...
public class YLaunchDelayer implements YTimedObject {
    ...
    public boolean equals(Object other) {
        return (other instanceof org.yawlfoundation.yawl.engine.time.YLaunchDelayer) &&
                ((getOwnerID() != null) ?
                 getOwnerID().equals(((org.yawlfoundation.yawl.engine.time.YLaunchDelayer) other).getOwnerID()) :
                 super.equals(other));
    }
    ...
    public void handleTimerExpiry() {
        try {
            ...
            LogManager.getLogger(org.yawlfoundation.yawl.engine.time.YLaunchDelayer.class).error(
