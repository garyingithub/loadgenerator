...
import org.yawlfoundation.yawl.engine.time.*;
...
public class YTimer extends Timer {
    ...
    private static org.yawlfoundation.yawl.engine.time.YTimer _me;
    ...
    public static org.yawlfoundation.yawl.engine.time.YTimer getInstance() {
        if (_me == null) _me = new org.yawlfoundation.yawl.engine.time.YTimer() ;
        return _me ;
    }
    ...
    public org.yawlfoundation.yawl.engine.time.YTimedObject cancelTimerTask(String itemID) {
        org.yawlfoundation.yawl.engine.time.YTimedObject result = null;
    ...
    public long schedule(org.yawlfoundation.yawl.engine.time.YTimedObject timee, long durationAsMilliseconds) {
        schedule(new TimeKeeper(timee), durationAsMilliseconds) ;
        return System.currentTimeMillis() + durationAsMilliseconds;
    }


    public long schedule(org.yawlfoundation.yawl.engine.time.YTimedObject timee, Date expiryTime) {
        schedule(new TimeKeeper(timee), expiryTime) ;
        return expiryTime.getTime();
    }


    public long schedule(org.yawlfoundation.yawl.engine.time.YTimedObject timee, Duration duration) {
        long durationAsMilliseconds = duration.getTimeInMillis(new Date());
        return schedule(timee, durationAsMilliseconds);
    }


    public long schedule(org.yawlfoundation.yawl.engine.time.YTimedObject timee, long count, TimeUnit unit) {
        long msecFactor = 1;
        int dateFactor = 1;
    ...
    private class TimeKeeper extends TimerTask {
        ...
        private org.yawlfoundation.yawl.engine.time.YTimedObject _owner ;

        protected TimeKeeper(org.yawlfoundation.yawl.engine.time.YTimedObject owner) {
            _owner = owner;
